...
const createBooking = async (req, res) => {
    ...
    const booking = new Booking({
        ...
        status: 'CONFIRMED', // PayPal is already approved by the time createBooking is called
        paymentMethod: paymentMethod,
        paymentStatus: (paymentMethod === 'ON_SITE' || paymentMethod === 'CARD') ? 'PENDING' : 'PAID', // Card and OnSite start pending. PayPal is already paid.
