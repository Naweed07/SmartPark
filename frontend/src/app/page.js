    ...
    <main className="min-h-screen bg-soft-light overflow-hidden">
      ...
      <div className="w-full bg-[#E6EDF2] px-4 md:px-8 lg:px-12 py-20 md:py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 relative z-10">
            <h1 className="txt-dark-blue text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-2 tracking-tight">
              SmartPark: <br />
            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 rounded-3xl p-6 md:p-8 flex flex-col xl:flex-row items-center xl:items-start justify-between gap-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mt-2">
              <div className="text-center xl:text-left">
                <h4 className="text-[#0A1A3F] font-extrabold text-lg mb-2">
      ...
      <div className="py-32 px-6 max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-20 relative z-10">
          <h2 className="text-4xl md:text-4xl text-[#0A1A3F] font-bold mb-6 tracking-tight">
            How It Works
          </h2>
        ...
        <Row gutter={[48, 48]} className="relative justify-center z-10">
          ...
          <Col xs={24} lg={8} className="relative z-10 flex">
            <div className="bg-white rounded-[2.5rem] p-10 shadow-[0_20px_40px_rgba(10,26,63,0.06)] border border-gray-100 flex flex-col items-center text-center w-full transform transition-all hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(19,99,223,0.1)] group">
              <div className="relative mb-10 w-24 h-24">
                <div className="absolute inset-0 bg-[#E6EDF2] rounded-full scale-0 group-hover:scale-110 transition-transform duration-500"></div>
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-4xl text-[#1363DF] font-bold shadow-lg border-2 border-[#1363DF]/10 relative z-10">
                  1
                </div>
                <div className="absolute -bottom-3 -right-3 w-12 h-12 bg-[#0A1A3F] rounded-full flex items-center justify-center text-white shadow-lg z-20">
                  <SearchOutlined className="text-xl" />
                </div>
              </div>
              <h4 className="text-2xl font-bold mb-4 text-[#0A1A3F]">Search Location</h4>
          ...
          <Col xs={24} lg={8} className="relative z-10 flex">
            <div className="bg-white rounded-[2.5rem] p-10 shadow-[0_20px_40px_rgba(10,26,63,0.06)] border border-gray-100 flex flex-col items-center text-center w-full transform transition-all hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(19,99,223,0.1)] group">
              <div className="relative mb-10 w-24 h-24">
                <div className="absolute inset-0 bg-[#E6EDF2] rounded-full scale-0 group-hover:scale-110 transition-transform duration-500"></div>
                <div className="w-24 h-24 bg-[#0A1A3F] rounded-full flex items-center justify-center text-4xl text-white font-bold shadow-xl relative z-10 ring-8 ring-[#0A1A3F]/10">
                  2
                </div>
                <div className="absolute -bottom-3 -right-3 w-12 h-12 bg-[#1363DF] rounded-full flex items-center justify-center text-white shadow-lg z-20">
                  <SafetyCertificateOutlined className="text-xl" />
                </div>
              </div>
              <h4 className="text-2xl font-bold mb-4 text-[#0A1A3F]">Book & Pay</h4>
              <p className="text-gray-500 leading-relaxed">
          ...
          <Col xs={24} lg={8} className="relative z-10 flex">
            <div className="bg-white rounded-[2.5rem] p-10 shadow-[0_20px_40px_rgba(10,26,63,0.06)] border border-gray-100 flex flex-col items-center text-center w-full transform transition-all hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(19,99,223,0.1)] group">
              ...
              <h4 className="text-2xl font-bold mb-4 text-[#0A1A3F]">Park Seamlessly</h4>
              <p className="text-gray-500 leading-relaxed">
      ...
      <div className="relative pt-24 pb-32 overflow-hidden">
        {/* Background Split */}
        <div className="absolute top-0 left-0 w-full h-[45%] bg-[#DCE4ED] z-0"></div>
        <div className="absolute bottom-0 left-0 w-full h-[55%] bg-[#0A1A3F] z-0"></div>

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl text-[#0A1A3F] font-bold m-0">
              Our Solutions
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-20">
            {/* Card 1 */}
            <div className="bg-white rounded-2xl p-8 shadow-xl flex flex-col h-full transform transition-transform hover:-translate-y-2 duration-300">
              <div className="h-40 w-full mb-6 flex items-center justify-center">
                <P2PListingIllustration />
              </div>
              <h3 className="text-[#0A1A3F] font-bold text-center text-lg mb-4">
                Peer-to-Peer Listing
              </h3>
              <p className="text-gray-500 text-sm text-center flex-grow leading-relaxed">
              ...
              <div className="mt-6 flex justify-end">
                <Link
                  href="#"
                  className="text-[#0A1A3F] font-semibold flex items-center gap-2 hover:text-[#1363DF] transition-colors text-sm"
                >
      ...
      <div className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl text-[#0A1A3F] font-bold mb-4">
        ...
        <div className="max-w-6xl mx-auto">
          <Carousel autoplay effect="fade" dotPosition="bottom" className="pb-12 custom-carousel">
            {/* Carousel Item 1 */}
            <div>
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col md:flex-row items-center gap-8 mx-4 my-2">
                <div className="w-24 h-24 shrink-0 rounded-full overflow-hidden border-4 border-[#E6EDF2]">
                  <img
                ...
                <div className="text-center md:text-left">
                  ...
                  <div>
                    <h4 className="text-[#0A1A3F] font-bold text-lg">Nuwan P.</h4>
            ...
            <div>
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col md:flex-row items-center gap-8 mx-4 my-2">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div>
                    <h4 className="text-[#0A1A3F] font-bold text-lg">Hiruni D.</h4>
                    <p className="text-gray-400 text-sm">Space Owner</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col md:flex-row items-center gap-8 mx-4 my-2">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div>
                    <h4 className="text-[#0A1A3F] font-bold text-lg">Tharusha K.</h4>
